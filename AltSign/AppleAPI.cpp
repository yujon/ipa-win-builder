...
bool decompress(const uint8_t* input, size_t input_size, std::vector<uint8_t>& output)
{
	...
	bool supportedDefault = web::http::compression::builtin::supported();
	bool supportedZip = web::http::compression::builtin::algorithm::supported(web::http::compression::builtin::algorithm::GZIP);
	bool supportedBri = web::http::compression::builtin::algorithm::supported(web::http::compression::builtin::algorithm::BROTLI);
	auto decompressor1 = web::http::compression::builtin::get_decompress_factory(web::http::compression::builtin::algorithm::DEFLATE);
				...
				.then([=](std::vector<unsigned char> compressedData)
					{
						...
						{
							const uint8_t* data = compressedData.data();
							decompress(data, (size_t)compressedData.size(), decompressedData);
						}
