...
public:
	...
	virtual std::string localizedDescription() const
	{
		...
		case ConnectionErrorCode::InvalidRequest:
			ss << deviceName << " received an invalid request from MiniappBuilder.";
			break;

		case ConnectionErrorCode::InvalidResponse:
			ss << "MiniappBuilder received an invalid response from " << deviceName << ".";
			break;
		...
		case ConnectionErrorCode::SSL:
			ss << "MiniappBuilder could not establish a secure connection to " << deviceName << ".";
			break;

		case ConnectionErrorCode::TimedOut:
			ss << "MiniappBuilder's connection to " << deviceName << " timed out.";
			break;
